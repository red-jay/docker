...
for pkg in xen-system-amd64 libvirt-bin debootstrap virtinst libguestfs-tools systemd-sysv pinentry-tty rrdtool nut lm-sensors tmux vlan lsb-base firewalld ; do
