...
virt-install --location http://192.168.128.129/bootstrap/centos7/ --name netmgmt.${1} --memory 1280 --os-variant rhel7.4 --disk size=12 --graphics none --network bridge=netm --network bridge=vmm --extra-args="console=ttyS0,115200n8 ks=http://192.168.128.129/bootstrap/ks/netmgmt.ks site=${1} rd.neednet=1 ip=eth1:dhcp biosdevname=0 net.ifnames=0" --noautoconsole --noreboot --wait -1
